            ...
            <div class="row justify-content-center">
                <div class="col-lg-10">
                    <div class="card p-4 shadow text-dark bg-white">
                        <form class="row g-3 align-items-end text-start">
                            <div class="col-md-4">
                            ...
                            <div class="col-md-4">
                                ...
                                <select class="form-select">
                                    <option selected>Sélectionnez une destination...</option>
                                    <option>Caen</option>
                                    <option>Rouen</option>
                                    <option>Granville</option>
                                    <option>Evreux</option>
                            ...
                            <div class="col-md-4">
                                <button type="submit" class="btn btn-viking w-100 py-2 fw-bold">Rechercher un
                                    trajet</button>
                            </div>
                        </form>
                    </div>
            ...
            <div class="col-md-4">
                <div class="card h-100 border-0 shadow-sm p-3 bg-white">
                    <div class="card-body">
                        ...
                        <p class="text-muted small">Consultez l'ensemble de nos lignes de cars normands traversant la
                            région.</p>
            ...
            <div class="col-md-4">
                <div class="card h-100 border-0 shadow-sm p-3 bg-white">
                    <div class="card-body">
                        ...
                        <p class="text-muted small">Ne ratez plus jamais votre car. Visualisez les fiches horaires par
                            portion de ligne.</p>
                    ...
                    <div class="card-body">
                        <div class="mb-3 text-danger">
                            <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="currentColor"
                                ...
                                <path
                                    d="M5.5 5.5a.5.5 0 1 1 0-1 .5.5 0 0 1 0 1m0 1a1.5 1.5 0 1 0 0-3 1.5 1.5 0 0 0 0 3M1 7.086a1 1 0 0 0 .293.707L8.75 15.25l-.043.043a1 1 0 0 1-1.414 0l-7-7A1 1 0 0 1 0 7.586V3a1 1 0 0 1 1-1z" />
                            </svg>
                        </div>
                        <h3 class="h5 fw-bold text-viking-dark">Grille Tarifaire</h3>
                        <p class="text-muted small">Consultez notre tarification simple et transparente calculée selon
    ...
    <?php if (!isset($_SESSION["id"])): ?>
        <section id="inscription" class="bg-dark text-white py-5">
            <div class="container text-center">
                ...
                <p class="lead text-secondary mb-4">Créez un compte gratuitement pour cumuler des points à chaque voyage et
                    débloquer des réductions sur vos prochains billets !</p>
